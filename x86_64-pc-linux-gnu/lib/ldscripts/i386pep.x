...
SEARCH_DIR("/drone/src/build-clang/install/x86_64-pep/lib"); SEARCH_DIR("/drone/src/build-clang/install/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
